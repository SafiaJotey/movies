  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-16 px-4 bg-gray-100 text-gray-800">
      ...
      <button
        ...
        className="mt-4 bg-gray-600 hover:bg-gray-700 text-white py-2 px-4 rounded-md transition duration-300 shadow-md focus:outline-none focus:ring-2 focus:ring-gray-500"
      >
        Go Back
      </button>
